    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <div class="controls">
                    <fieldset>
                        <input type="checkbox" id="checkbox_1" name="brand"  value="1">
                    ...
                    <fieldset>
                        <input type="checkbox" id="checkbox_4" name="slider" value="1">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <div class="controls">
                    ...
                    <fieldset>
                        <input type="checkbox" id="checkbox_15" name="adminuserrole" value="1">
                        <label for="checkbox_15">Admin User Role</label>
                               ...
                               <div class="text-xs-right">
                                   <button type="submit" class="btn btn-rounded btn-info">Add Admin User</button>
                               </div>
                           </form>
