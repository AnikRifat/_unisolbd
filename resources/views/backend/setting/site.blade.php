    ...
    <div class="container-full">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form method="post" action="{{ route('site-setting.update', $setting->id) }}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea rows="1" type="text" name="company_address" class="form-control form-control-sm">{{ $setting->company_address }} </textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <textarea id="editor1" name="about_us" rows="10" cols="80">{{ $setting->about_us }} </textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <textarea id="editor2" name="faqs" rows="10" cols="80">{{ $setting->faqs }} </textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <textarea id="editor3" name="terms_condition" rows="10" cols="80">{{ $setting->terms_condition }} </textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="editor4" name="quotation_notice" rows="10" cols="80">{{ $setting->quotation_notice }} </textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
