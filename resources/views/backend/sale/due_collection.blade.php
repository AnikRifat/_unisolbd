    ...
    <div class="container-full">
        ...
        <section class="content">
            <div class="box-header with-border py-0">
                <h4>Sale Due Collection</h4>
                <h6>Update Sale Due</h6>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        $(document).ready(function() {
            ...
            function searchInvoice(){
                ...
                if (selectedInvoiceNumber != "") {
                    $.ajax({
                        type: "get",
                        url: "{{ route('sale-payment-history') }}",
                        data: {
                        ...
                        success: function(response) {
                            ...
                            var firstItem = response[
                            0]; // Get the first item in the response array
