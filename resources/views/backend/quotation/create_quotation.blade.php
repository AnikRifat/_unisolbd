...
@section('admin')
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="box-header with-border py-0">
                        ...
                        <h4>{{ $action === 'edit' ? 'Edit ' : 'Add ' . $action }}</h4>
                        <h6>{{ $action === 'edit' ? 'Edit/Update ' : 'Add/Store ' . $action }}</h6>
                            ...
                            <div class="row">
                                                ...
                                                <select class="form-control form-control-sm select2" id="vendor_id"
                                                    ...
                                                    @foreach ($vendors as $customer)
                                                        <option value="{{ $customer->id }}"
                                                            {{ isset($customerPackage) && $customerPackage->customer_id == $customer->id ? 'selected' : '' }}>
                                ...
                                @else
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            <label
                                                class="col-form-label col-md-4">{{ $type === 'sale' ? 'Customers' : 'Suppliers' }}
                                                : </label>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <div class="d-flex">
                                                        <select class="form-control form-control-sm select2" id="vendor_id"
                                                            name="vendor_id">
                                                            <option value="">Choose
                                                                {{ $type === 'sale' ? 'Customer' : 'Supplier' }}</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control current-date" type="date"
                                                value="{{ isset($customerPackage) && $customerPackage->date != null ? $customerPackage->date : '' }}"
                                                name="date">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                                ...
                                                <div class="controls">
                                                    <div class="input-group">
                                                        <input id="sale_person_id" list="sale_person"
                                                            value="{{ isset($customerPackage) && $customerPackage->admin != null ? $customerPackage->admin->name : '' }}"
                                                        ...
                                                        <input type="hidden" name="sale_person"
                                                            value="{{ isset($customerPackage) && $customerPackage->admin != null ? $customerPackage->admin->id : '' }}"
                                                            class="form-control form-control-sm">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>To : </label>
                                            <div class="controls">
                                                <textarea rows="3" name="to" id="to" class="form-control" placeholder="To" aria-invalid="false">{{ isset($customerPackage) ? $customerPackage->subject : '' }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea rows="3" name="subject" id="subject" class="form-control" placeholder="Subject"
                                                    aria-invalid="false">{{ isset($customerPackage) ? $customerPackage->subject : '' }}</textarea>
                                        ...
                                        <tfoot id="tFooter" class="d-none">
                                            <tr>
                                                ...
                                                <td class='column-100 px-0 pb-0 font-weight-bold'><input
                                                        value="{{ isset($customerPackage) && $customerPackage->total != null ? $customerPackage->total : '' }}"
                                            ...
                                            <tr>
                                                ...
                                                <td class='column-100 p-0 font-weight-bold'><input
                                                        ...
                                                        value="{{ isset($customerPackage) && $customerPackage->discount != null ? $customerPackage->discount : '' }}"
                                            ...
                                            <tr>
                                                ...
                                                <td class='column-100 px-0 pt-0 font-weight-bold'><input type="text"
                                                        value="{{ isset($customerPackage) && $customerPackage->net_payable != null ? $customerPackage->net_payable : '' }}"
                                                        id="netPayable" name="net_payable" value="0"
                                                        style="border:0px" readonly></td>
                                            </tr>

                                            @if ($type === 'invoice' || $type === 'sale' || $type === 'purchase')
                                                <tr>
                                                    <td colspan="6"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class='column-100 p-0 font-weight-bold'><input type="text"
                                                            ...
                                                            value="{{ isset($customerPackage) && $type === 'invoice' && $customerPackage->net_payable != null ? $customerPackage->net_payable : '' }}"
    ...
    <script>
        var userManagementStoreRoute = "{{ route('user-management.store') }}";
        var productCreate = "{{ route('product.create') }}";
        var latestQuotation = "{{ route('customer-latest-quotation', ':id') }}";
        var updateProduct = "{{ route('update.quotation.product', ':id') }}";
        var latestProductInfo = "{{ route('get.sale.product') }}";
        var type = {!! json_encode($type) !!};

        console.log("type : ",type);
        var products = {!! json_encode($products) !!};
        var units = {!! json_encode($units) !!};
        var customerPackageId = {{ isset($customerPackage) ? $customerPackage->id : 'undefined' }};
    ...
    <script src="{{ asset('backend/custom/assets/js/add_sales_person.js') }}"></script>
    <script src="{{ asset('backend/custom/assets/js/add_vendor.js') }}"></script>
    <script src="{{ asset('backend/custom/assets/js/common.js') }}"></script>
                    ...
                    success: function(data) {
                        ...
                        if (type === 'quotation' || type === 'edit') {
                            ...
                            if (type === 'sale') {
                                if (preview) {
                                    var newTabUrl =
                                        "{{ route('preview.quotation-or-invoice.report', ['type' => 'sale', 'id' => '__id__']) }}";
                                    newTabUrl = newTabUrl.replace('__id__', data.saleInvoice);
                                    var saleReportWindow = window.open(newTabUrl, "_blank");
    ...
    <script src="{{ asset('backend/custom/assets/js/add_product.js') }}"></script>
    <script src="{{ asset('backend/custom/assets/js/calculation.js') }}"></script>
    <script src="{{ asset('backend/custom/assets/js/latest_quotation.js') }}"></script>
@endsection
