...
@section('admin')
                            ...
                            <div class="row">
                                        ...
                                        <div class="d-flex">
                                            <select class="form-control form-control-sm select2" id="customer_id"
                                                ...
                                                @foreach ($customers as $customer)
                                                    <option value="{{ $customer->id }}" {{ $customerPackage->customer_id == $customer->id ? 'selected' : '' }} >{{ $customer->name }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control" type="date" value="{{ $customerPackage->date }}" name="date">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4">SalesPerson : </label>
                                        <div class="col-md-8">
                                            <select name="sale_person" class="form-control form-control-sm select2">
                                                <option>Choose Person</option>
                                                @foreach ($admin as $item)
                                                <option value="{{ $item->id }}" {{ $item->id == $customerPackage->created_by? 'selected':'' }}>{{ $item->name }}</option>
                                                @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Bill To : </label>
                                        <div class="controls">
                                            <textarea rows="1" name="to" id="to" class="form-control" placeholder="Bill To" aria-invalid="false">{{ $customerPackage->to }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Ship To : </label>
                                        <div class="controls">
                                            <textarea rows="1" name="subject" id="subject" class="form-control" placeholder="Ship To" aria-invalid="false">{{ $customerPackage->subject }}</textarea>
                                    ...
                                    <table id="saleList" class="table table-sm  table-bordered">
                                        ...
                                        <tbody id="addRow" class="addRow">
                                            ...
                                            <tr data-item-id='{{ $item->id }}'>
                                                ...
                                                <td class='column-80'>
                                                    <input type='text' class='form-control form-control-sm unit-name' name='unit_name[]' readonly value='{{ $item->unit->name }}' />
                                                </td>
                                                <td class='column-80 d-none'>
                                                    <input type='hidden' class='form-control form-control-sm unit-id' name='unit_id[]' readonly value='{{ $item->unit_id }}' />
                                                </td>
                                                <td class='column-80'>
                                                    <input type='text' class='form-control form-control-sm qty numeric-input' name='qty[]' value='{{ $item->qty ?? '' }}' />
                                                </td>
                                                <td class='column-100'>
                                                    <input type='text' class='form-control form-control-sm decimal-input sale-price' name='sale_price[]' value='{{ $item->price ?? '' }}' />
                                                </td>
                                                <td class='column-100'>
                                                    <input type='text' class='form-control form-control-sm discount-price' name='discount_price[]' value='{{ $item->discount ?? '' }}' />
                                                </td>
                                                <td class='column-100'>
                                                    <input type='text' class='form-control form-control-sm total' name='total[]' readonly value='{{ $item->total ?? '' }}' />
                                                </td>
                                                <td class='column-40'>
                                                    <button data-item-id='{{ $item->id  }}' class='btn btn-danger btn-sm delete-row'>
                                        ...
                                        <tfoot id="tFooter" class="d-none">
                                            <tr>
                                                ...
                                                <td class='column-100 px-0 pb-0 font-weight-bold'><input 
                                                        name="grand_total" value="{{ $customerPackage->total }}" id="grandTotal" type="text" style="border:0px"
                                                        readonly></td>
                                            </tr>
                                            <tr>
                                                <td colspan="5"></td>
                                                ...
                                                <td class='column-100 p-0 font-weight-bold'><input
                                                        ...
                                                        type="text" value="{{ $customerPackage->discount }}" name="total_discount"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class='column-100 px-0 pt-0 font-weight-bold'><input type="text"
                                                        id="netPayable"  name="net_payable" value="{{ $customerPackage->net_payable }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            var customerPackageId={{ $customerPackage->id }};
