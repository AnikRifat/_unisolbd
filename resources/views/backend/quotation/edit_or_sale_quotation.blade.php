...
@section('admin')
    ...
    <div class="container-full">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-6">
                    <div class="box-header with-border py-0">
                        ...
                        @elseif ($type == 'sale')
                            <h4>Store Quotation Invoice</h4>
                            <h6>Add/Store Quotation Invoice</h6>
                        @elseif ($type == 'POS-Sale')
                            <h4>Store Sale Invoice</h4>
                            <h6>Add/Store Sale Invoice</h6>
                        @endif
            ...
            <form id="saleForm" method="post" action="{{ route($route) }}">
                @csrf
                <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                                ...
                                                <select class="form-control form-control-sm select2" id="customer_id"
                                                    ...
                                                    @foreach ($customers as $customer)
                                                        <option value="{{ $customer->id }}"
                                                            {{ $customerPackage->customer_id == $customer->id ? 'selected' : '' }}>
                                    ...
                                    @else
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-md-4">Customers : </label>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <div class="d-flex">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control {{ $type == 'POS-Sale' ? 'current-date' : '' }}"
                                                type="date"
                                                value="{{ $type != 'POS-Sale' ? $customerPackage->date : '' }}"
                                                name="date">
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    <div class="input-group">
                                                        <input id="sale_person_id"
                                                            value="{{ $customerPackage != null && $customerPackage->admin != null ? $customerPackage->admin->name : '' }}"
                                                            list="sale_person" class="form-control form-control-sm">
                                                        ...
                                                        <input
                                                            value="{{ $customerPackage != null && $customerPackage->admin != null ? $customerPackage->sale_person_id : '' }}"
                                                            type="hidden" name="sale_person"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>To : </label>
                                        <div class="controls">
                                            <textarea rows="3" name="to" id="to" class="form-control" placeholder="Bill To"
                                                aria-invalid="false">{{ $type != 'POS-Sale' ? $customerPackage->to : '' }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Subject : </label>
                                        <div class="controls">
                                            <textarea rows="3" name="subject" id="subject" class="form-control" placeholder="Ship To"
                                                aria-invalid="false">{{ $type != 'POS-Sale' ? $customerPackage->subject : '' }}</textarea>
                                ...
                                <div class="table-responsive">
                                    <table id="saleList" class="table table-sm  table-bordered">
                                        ...
                                        <tbody id="addRow" class="addRow">
                                            ...
                                            @if ($type != 'POS-Sale')
                                                @foreach ($customerPackage->customerPackageItems as $item)
                                                    <tr data-item-id='{{ $item->id }}'>
                                                        <input type='hidden' name='item_id[]' id='item_id'
                                                            value='{{ $item->id }}'>
                                                        <td class='column-140 product_td'>
                                                            <input type='text'
                                                                value='{{ isset($item->product) && $item->product->quotation_product_name ? $item->product->quotation_product_name : '' }}'
                                                                list='products' name='product_name[]'
                                                                class='form-control form-control-sm product-select'>
                                                            <datalist id='products'>
                                                                @foreach ($products as $product)
                                                                    <option data-product-id='{{ $product->id }}'
                                                                        value='{{ $product->quotation_product_name }}'>
                                                                    </option>
                                                                @endforeach
                                                            </datalist>
                                                        ...
                                                        <td class='column-280'>
                                                            <textarea type='text' rows='2' class='form-control form-control-sm description' name='description[]'
                                                                style='height: 26px;'>
                                                        {{ $item->product->quotation_short_descp ?? '' }}
                                                    </textarea>
                                                        </td>
                                                        <td class="column-80">
                                                            <select class='form-control form-control-sm select2 unit-id'
                                                                ...
                                                                @foreach ($units as $unit)
                                                                    <option value="{{ $unit->id }}"
                                                                        {{ isset($item->unit) && $item->unit->id == $unit->id ? 'selected' : '' }}>
                                                                        {{ $unit->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <td class='column-100'>
                                                            <input type='text'
                                                                ...
                                                                name='purchase_price[]'
                                                                value='{{ isset($item->product) && isset($item->product->latestPurchase) ? $item->product->latestPurchase->price : (isset($item->product) ? $item->product->purchase_price : '') }}' />
                                                        </td>
                                                        <td class='column-100'>
                                                            <input type='text'
                                                                class='form-control form-control-sm decimal-input sale-price'
                                                                name='sale_price[]' value='{{ $item->price ?? '' }}' />
                                                        </td>
                                                        <td class='column-100'>
                                                            <input type='text'
                                        ...
                                        <tfoot id="tFooter" class="d-none">
                                            <tr>
                                                ...
                                                <td class='column-100 px-0 pb-0 font-weight-bold'><input
                                                        name="grand_total"
                                                        value="{{ $type != 'POS-Sale' ? $customerPackage->total : '' }}"
                                                        id="grandTotal" type="text" style="border:0px" readonly></td>
                                            </tr>
                                            <tr>
                                                <td colspan="6"></td>
                                                ...
                                                <td class='column-100 p-0 font-weight-bold'><input
                                                        ...
                                                        type="text"
                                                        value="{{ $type != 'POS-Sale' ? $customerPackage->discount : '' }}"
                                                        name="total_discount"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class='column-100 p-0 font-weight-bold'><input type="text"
                                                        id="netPayable" name="net_payable"
                                                        value="{{ $type != 'POS-Sale' ? $customerPackage->net_payable : '' }}"
                            ...
                            <div id="btnSubmit" class="row justify-content-center  d-none">
                                ...
                                @if ($type == 'edit')
                                    ...
                                    <button type="submit" id="btnRecordPreview" class="btn btn-info btn-sm ml-2">Record
                                        ...
                                        Preview</button>
                                @else
                                    <button type="submit" id="btnSaveInvoice" class="btn btn-success btn-sm">Record &
                                        Save</button>
                                    <button type="submit" id="btnPreviewInvoice" class="btn btn-info btn-sm ml-2">Record
                                        &
                                        Preview</button>
                                @endif
    ...
    <script>
        ...
        $(document).ready(function() {
                    ...
                    if (product_id == "" || product_id != selectedProductId || product_id != undefined) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                currentRow.find(".sale-price").val(response.latestSale !==
                                    null ?
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        currentRow.find(".unit-id").val(response.product.unit.id).trigger(
                            'change');
                        // currentRow.find(".unit-name").val(response.product.unit.name);
                        currentRow.find(".sale-price").val(response.latestSale !== null ?
                            response.latestSale.price :
                            response.product.selling_price);
            ...
            //update product name,unit,description,pruchase_price
            function handleChange(element, className, propertyName) {
                ...
                if (product_id !== "") {
                    ...
                    if (originalProduct && String(originalProduct[propertyName]) !== String(selectedValue)) {
                        ...
                        console.log("unit_id : ", selectedValue);
                        console.log("originalProduct[propertyName] : ", originalProduct[propertyName]);
            ...
            $(document).on('keydown',
                '.product-select, .description,.unit-id, .qty,.purchase-price, .sale-price, .discount-price, #total_discount,#saleList #totalPaid',
            ...
            function isRowValid(row) {
                ...
                row.find('.product-select,.description,.unit-id, .qty,.purchase-price,.sale-price').each(
                    function() {
                ...
                $("#saleList").on("click", ".delete-row", function(event) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var updateUrl =
                                "{{ route('quotation-item.destroy', ':quotation-item') }}";
                            ...
                            if (itemId != "undefined") {
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        showToastr(response.notification.type,
                                            response
                                            .notification.message);

                                        $('#grandTotal').val(response
                                            .customerPackage
                                            .total);
                                        $('#total_discount').val(response
                                            .customerPackage
                                            .discount);
                                        $('#netPayable').val(response
                                            .customerPackage
                                            .net_payable);
                                        $('#addRow').empty();

                                        $.each(response.customerPackageItems,
                                            function(
                                                index, item) {
                            ...
                            console.log("addRowTr : ", $("#addRow tr").length);
                            var hasRows = $("#addRow tr").length > 0;
            ...
            function submitForm(preview) {
                ...
                var invoiceNo;
                @if ($type == 'sale')
                    invoiceNo = {!! json_encode($customerPackage->invoice_no) !!}
                @endif
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (type == "edit") {
                            ...
                            console.log("data : ", data);
                            saleInvoiceId = data.saleInvoice
                            if (preview) {
                                var newTabUrl =
                                    "{{ route('preview.quotation-or-invoice.report', ['type' => 'quotation-invoice', 'id' => '__id__']) }}";
                                newTabUrl = newTabUrl.replace('__id__', saleInvoiceId);
                                var saleReportWindow = window.open(newTabUrl, "_blank");
                            }

                            window.location.href = "{{ route('view.sale') }}";
            ...
            // Event handling for save and preview button
            $('#btnSaveInvoice').on('click', function(event) {
                event.preventDefault();

                if (checkQuotationItems()) {
                    // console.log("checkQuotationItems : ", checkQuotationItems());
                    submitForm(false); // Pass true to indicate preview
                }
            });

            $('#btnPreviewInvoice').on('click', function(event) {
                event.preventDefault();
    ...
    <script>
        ...
        $(document).on('keyup', '.qty, .sale-price, .discount-price, #total_discount, #saleList #totalPaid', function(
            event) {
    ...
    <!-- Load the latest customer and subject -->
    <script>
        $(document).ready(function() {
            $(document).on('change', '#customer_id', function() {
                ...
                if (customerId !== "") {
                    var updateUrl = "{{ route('customer-latest-quotation', ':id') }}";
            ...
            $('#vendorForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response.vendors, function(index, customer) {
                            selectElement.append('<option value="' + customer.id +
                                '">' + customer.name + '</option>');
                        });
