...
<head>
    <title>Suppliers Wise Report</title>
                    ...
                    <div class="invoice-inner clearfix">
                        <div class="invoice-info clearfix" id="invoice-content">
                            <div class="row g-0 text-center">
                                ...
                                <h6>Supplier Wise Sale Details For All Products For {{ \Carbon\Carbon::createFromFormat('m/d/Y', $startDate)->format('F j, Y') }} To {{ \Carbon\Carbon::createFromFormat('m/d/Y', $endDate)->format('F j, Y') }}</h6>
                            </div>
                                ...
                                <div class="row">
                                        <div class="m-3 mb-30">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                <p class="m-0"><span class="font-weight-bold">Name : </span>{{ $invoice->first()->purchaseDetails->first()->supplier->name }}</p>
                                                <p class="m-0"><span class="font-weight-bold">Email : </span>{{ $invoice->first()->purchaseDetails->first()->supplier->email }} </p>
                                                </div>
                                                <div class="col-6">
                                                <p class="m-0"><span class="font-weight-bold">Address : </span>{{ $invoice->first()->purchaseDetails->first()->supplier->address }}</p>
                                                <p class="m-0"><span class="font-weight-bold">Phone : </span>{{ $invoice->first()->purchaseDetails->first()->supplier->phone }}</p>
                                                </div>
                                            </div>
                                    ...
                                    <table class="table mb-0 table-striped invoice-table">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($invoice as $item)
                                                @foreach ($item->purchaseDetails as $detail)
                                                    <tr class="tr">
                                                        <td>
                                            ...
                                            <tr class="tr3 text-center font-weight-bold">
                                                <td colspan="7"></td>
