                    ...
                    <div class="invoice-inner clearfix">
                        <div class="invoice-info clearfix" id="invoice-content">
                            <div class="row g-0 text-center">
                                ...
                                <h6>Sale Details For All Products For {{ \Carbon\Carbon::createFromFormat('m/d/Y', $startDate)->format('F j, Y') }} To {{ \Carbon\Carbon::createFromFormat('m/d/Y', $endDate)->format('F j, Y') }}</h6>
                            </div>
