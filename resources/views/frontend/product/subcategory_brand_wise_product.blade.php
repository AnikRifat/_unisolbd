...
@section('content')
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                            ...
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1" aria-current="page"><a
                                href="{{ url('category/product/' . $SubcategoryBrandWiseProducts->first()->subcategory->category_slug . '/' . encrypt($SubcategoryBrandWiseProducts->first()->category->id)) }}">{{ $SubcategoryBrandWiseProducts->first()->category->category_name }}</a>
                            </li>
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1" aria-current="page"><a
                                    href="{{ url('subcategory/product/' . $SubcategoryBrandWiseProducts->first()->subcategory->subcategory_slug . '/' . encrypt($SubcategoryBrandWiseProducts->first()->subcategory->id)) }}">{{ $SubcategoryBrandWiseProducts->first()->subcategory->subcategory_name }}</a>
                            </li>
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page"><a
                                href="{{ url('brand_wise_subcategory/product/' . $SubcategoryBrandWiseProducts->first()->subcategory->subcategory_slug . '/' . encrypt($SubcategoryBrandWiseProducts->first()->subcategory->id).'/'.base64_encode($brand->id)) }}">{{ $brand->brand_name }}</a>
                            </li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="d-none d-xl-block col-xl-3 col-wd-2gdot5">
                    <div class="mb-2">
                        ...
                        <div class="border-bottom pb-2 mb-2">
                            ...
                            {{-- @php
                                $brandCounts = $SubcategoryBrandWiseProducts->groupBy('brand_id')->map(function ($products, $brandId) {
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            var slicedProducts = {!! json_encode($SubcategoryBrandWiseProducts->toArray()) !!};
            var currentPage = 1;
            ...
            function applyFiltersAndSort() {
                ...
                slicedProducts = {!! json_encode($SubcategoryBrandWiseProducts->toArray()) !!};
                // Apply brand filter
