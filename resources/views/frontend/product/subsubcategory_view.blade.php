...
@section('content')
    ...
    <main id="content" role="main">
                ...
                <div class="my-md-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                            ...
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="{{ url('category/product/'.$SubSubCategoryWiseProducts->first()->category->category_slug.'/'.encrypt($SubSubCategoryWiseProducts->first()->category->id)) }}">{{ $SubSubCategoryWiseProducts->first()->category->category_name }}</a>

                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1" aria-current="page"><a
                                    href="{{ url('subcategory/product/'.$SubSubCategoryWiseProducts->first()->subcategory->subcategory_slug.'/'.encrypt($SubSubCategoryWiseProducts->first()->subcategory->id)) }}">{{ $SubSubCategoryWiseProducts->first()->subcategory->subcategory_name }}</a>

                            </li>
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page"><a
                                href="{{ url('subsubcategory/product/'.$SubSubCategoryWiseProducts->first()->subsubcategory->subsubcategory_slug.'/'.encrypt($SubSubCategoryWiseProducts->first()->subsubcategory->id)) }}">{{ $SubSubCategoryWiseProducts->first()->subsubcategory->subsubcategory_name }}</a>
        ...
        <div class="container">
            @php
            $brandCounts = $SubSubCategoryWiseProducts
                ->groupBy('brand_id')
                ...
                <div class="d-none d-xl-block col-xl-3 col-wd-2gdot5">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="border-bottom pb-2 mb-2">
                            ...
                            {{-- @php
                                $brandCounts = $SubSubCategoryWiseProducts->groupBy('brand_id')->map(function ($products, $brandId) {
            ...
            <div class="col-xl-9 col-wd-9gdot5">
                ...
                <div class="bg-gray-1 flex-center-between borders-radius-9 py-1">
                    ...
                    <div class="px-3 d-none d-xl-block">
                        <h4>{{ $SubSubCategoryWiseProducts->first()->subcategory->subcategory_name }}</h4>
                    </div>
                    <div class="d-flex">
                        <form method="get">
                            <!-- Select -->
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            var slicedProducts = {!! json_encode($SubSubCategoryWiseProducts->toArray()) !!};
            var currentPage = 1;
            ...
            function applyFiltersAndSort() {
                ...
                slicedProducts = {!! json_encode($SubSubCategoryWiseProducts->toArray()) !!};
                // Apply brand filter
