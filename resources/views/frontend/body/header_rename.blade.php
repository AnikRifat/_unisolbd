...
<header id="header" class="u-header u-header-left-aligned-nav">
    <div class="u-header__section">
        <!-- Topbar -->
        <div class="u-header-topbar py-2 d-none">
            <div class="container">
                            ...
                            <li
                                ...
                                @else
                                    ...
                                    <a href="{{ route('register') }}" role="button" class="u-header-topbar__nav-link"
                                        ...
                                        data-unfold-animation-out="fadeOutRight" data-unfold-duration="500">Sign in</a>
                                @endif
        ...
        <div class="floating_btn">
            <a type="button" href="{{ route('view.package') }}" class="contact_icon text-white font-weight-bold">
                Quotation Builder
            </a>
        </div>
                                                                                                        ...
                                                                                                        <li
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <a href="{{ url('subsubcategory/product/' .$subsubcat->subsubcategory->subsubcategory_slug. '/' . encrypt($subsubcat->subsubcategory_id)) }}"
                                                                                                                    class="u-header-collapse__nav-link">
                                                                                                                    {{ $subsubcat->subsubcategory->subsubcategory_name }}{{ $hasBrandOrSubSubcategory }}
                                                                                                                </a>
                                                                                                                <a class="u-header-collapse__nav-link {{ $hasBrandOrSubSubcategory? 'u-header-collapse__nav-pointer' : '' }} p-0 pl-3"
                                                                                                                    href="javascript:;"
                                ...
                                <li class="col d-xl-none px-2 px-sm-3 position-static">
                                    ...
                                    <div id="searchClassic"
                                        ...
                                        <form class="js-focus-state input-group px-3 ">
                                            <input class="form-control searchproduct-item-mobile" id="searchproduct-item-mobile" type="search"
                                                                                                        ...
                                                                                                        @endphp
                                                                                                            ...
                                                                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                                                                ...
                                                                                                                @if ($subsubcat->brand_id !=null)
                                                                                                                    <div class="hs-mega-menu vmm-tfw u-header__sub-menu" style="height: 500px"
