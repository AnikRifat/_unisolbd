                    ...
                    <li class="product-item mr-2">
                        <div class="js-slide">
                            <a href="{{ url('category/product/'.$category->category_slug.'/'.encrypt($category->id)) }}"
                                ...
                                <div class="d-flex justify-content-center align-items-center bg font-size-40 pt-4 rounded-circle-top width-122 height-75">
                                    <img src="{{ $category->category_icon }}" alt="">
                                </div>
                                <div class="bg-white px-2 pt-2 width-122">
                                    <h6 class="font-weight-semi-bold font-size-14 text-gray-90 mb-0 text-lh-1dot2">{{ $category->category_name }}</h6>
                                </div>
                            </a>
                        </div>
                    </li>
                    ...
                    <div class="product-item__outer h-100">
                        <div class="product-item__inner px-xl-4 p-3">
                            <div class="product-item__body pb-xl-2">
                                ...
                                <h5 class="mb-1 product-item__title"><a href="{{ url('/product/details/' .$product->product_slug. '/' .encrypt($product->id)) }}" class="text-blue font-weight-bold"  data-toggle="tooltip"  data-placement="top" title="{{ $product->product_name }}">{{ $product->product_name }}</a></h5>
                                <div class="mb-2">
...
<div class="flex-center-between mb-1">
    <div class="prodcut-price d-flex align-items-center flex-wrap position-relative">
        ...
        <ins class="font-size-20 text-red text-decoration-none mr-2"> {{ number_format($product->discount_price, 0, '.', ',') }}{{ $currency->symbol }}</ins>
