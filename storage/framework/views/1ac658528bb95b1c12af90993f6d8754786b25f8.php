							...
							<form method="POST" action="<?php echo e(isset($guard) ? url ($guard.'/login') : route('login')); ?>">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input  id="email" type="email"  value="<?php echo e(old('loginname')); ?>"  name="loginname" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="email">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password" value="<?php echo e(old('password')); ?>"  name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
...
<?php /**PATH /opt/lampp/htdocs/_unisolbd/resources/views/auth/admin_login.blade.php ENDPATH**/ ?>