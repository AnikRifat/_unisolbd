                    ...
                    <div class="invoice-inner clearfix">
                        <div class="invoice-info clearfix" id="invoice-content">
                            ...
                            <div class="text-center my-3">
                                <p class="font-weight-bold">Your Items for <?php echo e($customer_package->package->name); ?>
                            ...
                            <div class="row my-4">
                                <div class="col-4">
                                    <p class="m-0"><span class="font-weight-bold">Name :
                                        </span><?php echo e($customer_package->user->name); ?></p>
                                </div>
                                <div class="col-4">
                                    <p class="m-0"><span class="font-weight-bold">Phone :
                                        </span><?php echo e($customer_package->user->phone); ?></p>
                                </div>
                                <div class="col-4">
                                    <p class="m-0"><span class="font-weight-bold">Email :
                                        </span><?php echo e($customer_package->user->email); ?></p>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0 table-striped invoice-table">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $customer_package->customerPackageItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
...
<?php echo $__env->make('frontend.main_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/_unisolbd/resources/views/frontend/quotationbuilder/quotation_report_web.blade.php ENDPATH**/ ?>